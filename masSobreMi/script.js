...
const logLines = [
  ...
  { text: "", type: "out" },
  { text: "$ cat sobre-mi.md", type: "cmd" },
  { text: "> Sección con más detalle de mi perfil, trayectoria y forma de trabajar.", type: "out" },
  { text: "", type: "out" },
  { text: "$ ./build_seccion.sh --about", type: "cmd" },
  { text: "> Redactando contenido y maquetando... esto puede tardar unos días", type: "muted" },
